  ...
  return (
    <div className='absolute top-4 right-4 w-80 bg-white rounded-lg shadow-xl border border-gray-200 p-4 z-50 animate-fade-in fade-in'>
      <div className='flex justify-between items-center mb-4'>
        ...
        <button onClick={onClose}  className='p-1 hover:bg0gray-100 rounded-full'>
         ...
         <div className='grid grid-cols-2 gap-3'>
          <div>
              ...
              <div className='flex items-center gap-2 border border-gray-500 mb-1'>
                <input type='color' value={values.styles.backgroundColor === 'rgba(0,0,0,0)' ? '#ffffff': values.styles.backgroundColor} onChange={(e)=>handleStyleChange('backgraoundColor',e.target.value)} className='w-6 h-6  cursor-pointer' />
